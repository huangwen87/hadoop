/**
 * @date Tue Dec  3 14:44:57 2013
 * @author gumeng
 * @description 按照key来写文件，每个key对应一个文件
 */

package com.gw.common.mapred;
...
public class MultiOutputFormat<K extends WritableComparable<?>, V extends Writable>
    ...
    public class MultiRecordWriter extends RecordWriter<K, V> { 
		 ...
		 */ 
		protected  String generateFileNameForKey(String key ){
			return key + "_" + job.getTaskAttemptID();
		}
        ...
        @Override 
			...
			String baseName = generateFileNameForKey(key.toString()); 
